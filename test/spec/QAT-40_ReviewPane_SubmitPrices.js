...
suite(testSuiteName = 'QAT-40 - Review pane - Submit checked prices', () => {
  ...
  test('QAT-40 - Review pane - Submit checked prices', () => {
    ...
    browser.logger.info('Starting test for QAT-40 - Review pane - Submit checked prices');
    ...
    browser.pause(1000);
    expect(priceResults.length.toString()).to.eql(HomePage.homePriceCartText_Span.getText());
